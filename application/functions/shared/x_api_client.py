"""
X API v2 投稿クライアント (Azure Functions版)
        ...
        self.session.headers.update(
            {
                ...
                "User-Agent": "X-Scheduler-Pro-Functions/1.0",
            }
        )
